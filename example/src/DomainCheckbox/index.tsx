...
const DomainCheckboxExample = () => {
    ...
    return (
        <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
            ...
            <View style={{ flexDirection: "row", alignItems: 'center' }}>
                <DomainCheckbox checked={isChecked1} onChange={setIsChecked1} color="blue" size={30} />
                <Text>Option 2</Text>
            </View>
            <View style={{ flexDirection: "row", alignItems: 'center' }}>
                <DomainCheckbox checked={isChecked2} onChange={setIsChecked2} color="blue" size={30} />
                <Text>Option 3</Text>
            </View>
